...
export function createFreshIncident(id = crypto.randomUUID()): Incident {
  return { id, status: 'NEW', language: 'hinglish', description: '', entities: { phoneNumbers: [], upiIds: [], bankAccounts: [], urls: [], emails: [], transactionIds: [] }, evidence: [], timeline: [], actionPlan: [], complaint: { draft: '', reviewed: false, handoffStatus: 'not_ready' } };
}

...
export const metadata: Metadata = {
  ...
  description:
    'A secure cybercrime first-response workflow for persistent, evidence-backed, report-ready cases.',
  openGraph: {
    ...
    images: [
      {
        ...
        width: 1680,
        height: 945,
        alt: 'Cyber First Response — The first 30 minutes after a cybercrime.',
      },
    ],
  },
  twitter: {
